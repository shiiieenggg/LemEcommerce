...
<!--Category Title-->
<div class="Title">
        <h1 class="Title"><a href="index.php#Category"> <img class="icon" src="images\shampoo.png" alt="shampoo" height="70" width="70"></a>Sanitation</h1>
</div>
...
<div class="Pet">
        <div class="row">
            <div class=" col-6 Pet2">
                <h5><a href="Sanitation.php">Cat</a></h5>
            </div>
...
<script src="js/sanitationDog.js"></script>
<script src="js/app js/appSanDog.js"></script>
