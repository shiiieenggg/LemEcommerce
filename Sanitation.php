...
<section id="Title">
        <div class="container-fluid">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <a class="navbar-brand" href="home.php"><span style="color:#7AC7E6"> PURR</span><span style="color:#FFDB58">FECT</span></a>
...
<!--Category Title-->
<div class="Title">
        <h1 class="Title"> <a href="index.php#Category"><img class="icon" src="images/shampoo.png" alt="food" height="70" width="70"> </a>Sanitation</h1>
</div>

<!--Pet Categories-->
 <div class="Pet">
        <div class="row">
            <div class=" col-6 Pet1">
                <h5>Cat</h5>
            </div>
            <div class="col-6 Pet2">
                <h5> <a href="Sanitation(dog).php">Dog</a></h5>
            </div>
        </div>
...
<script src="js/sanitationCat.js"></script>
<script src="js/app js/appSanCat.js"></script>
</body>
</html>
