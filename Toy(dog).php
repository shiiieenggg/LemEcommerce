...
<!--Category title-->
<div class="Title">
        <h1 class="Title"> <a href="index.php#Category"><img class="icon" src="images/petoy.png" alt="food" height="70" width="70"></a> Toy</h1>
</div>
...
<script src="js/toysDog.js"></script>
<script src="js/app js/appToyDog.js"></script>
</body>
</html>
