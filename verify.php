...
<div>
      ...
      <div class="container11">
  			<br>An email was sent to your address. <br>Paste the code from the email here to verify your account<br>
  		<div>
...
<script src="js/foodsDog.js"></script>
<script src="js/app js/appFoodDog.js"></script>
